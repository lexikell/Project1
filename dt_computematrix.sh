...
#SBATCH --job-name=dt_cmatrix
#SBATCH --ntasks=15
#SBATCH --time=0-03:00:00
#SBATCH --mem-per-cpu=1G
#SBATCH --output=dt_cmatrix.%J.out
#SBATCH --error=dt_cmatrix.%J.err
...
#this had error after many hours... but the combo w/ heatmap (cmatrixheat) worked